...
# ---------------------------------------------------------------------------
# Costanti Golden Retry Loop — LO-02
# ---------------------------------------------------------------------------
GOLDEN_RETRY_MAX_ATTEMPTS: int = 6  # Tentativi massimi nel golden retry loop
GOLDEN_RETRY_MIN_WAIT: float = 5.0  # Attesa minima tra retry (secondi)
GOLDEN_RETRY_MAX_WAIT: float = 10.0  # Attesa massima tra retry (secondi)
